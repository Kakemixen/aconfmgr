...
TestAddConfig NoticePath "'"'/dir[1-9]/strayfile_*.txt'"'"
TestAddConfig NoticePath "'"'/dir*/strayfile-???.txt'"'"
TestAddConfig NoticePath "'"'/dir?/strayfile[a-b].txt'"'"
...
CopyFile /dir1/strayfile-one.txt
CopyFile /dir1/strayfile_abc.txt
CopyFile /dir1/strayfile_xyz.txt
CopyFile /dir2/strayfile_jeff.txt
CopyFile /dir3/strayfile-two.txt
